    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 font-mono text-center text-white">
                <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-4">Let's Innovate Your Profession</h1>
                ...
                <div className="relative inline-flex items-center justify-center px-6 py-3 text-lg font-medium text-white transition-all rounded-md focus:outline-none focus:ring">
                    <span
